            ...
            <div class="card-body">
                <div class="row g-3">
                    ...
                    <div class="row " id="imageContainer">
                        {{-- <div class="col-2 ">
                            <div class="card border border-3 border-primary m-2">
                                <img src="{{getImageUrlByUuid('7d595bfe148d00474c8ace67782bd24b')}}"  alt="">
                                <div class="">
                                    <button class="btn "><span><i class=" ri-download-cloud-2-line"></i></span></button>
                                </div>
                            </div>
                        </div> --}}
                    </div>
